...
ZVecResult ZDeque_init(
  ZDeque *deque, size_t count, size_t size,
...
ZVecResult ZDeque_copy(ZDeque *dest, const ZDeque *src);
ZVecResult ZDeque_at(const ZDeque *deque, size_t idx, void *out);
const void *ZDeque_get(const ZDeque *deque, size_t idx);
